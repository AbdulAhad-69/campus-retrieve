    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden md:flex flex-1 items-center justify-center px-8">
                <form action="/campus-retrieve/public/browse" method="GET" class="w-full max-w-lg relative">
                    <input type="text" name="q" class="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition" placeholder="Search for lost items...">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden group-hover:block border border-gray-100">
                        <a href="/campus-retrieve/public/profile" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">My Profile</a>
